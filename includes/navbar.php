...
<!-- <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"> -->
  ...
  <!-- <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">CALOSTORY</div>
  </a> -->
        ...
        <li class="nav-item dropdown no-arrow">
          <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
            ...
            <?php if (isset($profile->picture)) { ?>
              <img src="<?php echo $profile->picture; ?>" class="img-profile rounded-circle" alt="img user">
            <?php } else { ?>
              <img src="images/user.jpg" class="img-profile rounded-circle" alt="img user">
            <?php } ?>
          </a>
